...
static WebDriver driver;
	...
	public static String getData(int rowNo,int cellNo) throws IOException {
		String v = null;
		File loc = new File("C:\\Users\\GAWTHAM HANISH\\Downloads\\eclipse-committers-oxygen-3a-win32-x86_64\\eclipse\\bhuvanaselenium\\MyMaven\\src\\test\\java\\testdatas\\TestDataSignIn.xlsx");
...
public static void Action1(WebElement e) throws IOException {
	...
	screenShot(driver,"C:\\Users\\GAWTHAM HANISH\\Documents\\Selineum&java\\projectscreenshots\\signin.png");

}
public static void buttonclick(WebElement e) throws IOException {
e.click();
